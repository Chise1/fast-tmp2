...
# GOOGLE_CLIENT_ID="293106"
# GOOGLE_CLIENT_SECRET="5fd5ceca9a87b1f05ee5b39c48a77ad607fa2435797084685809b004"
app = FastAPI()
...
oauth.register(
    name="t1", server_metadata_url=CONF_URL, client_kwargs={"scope": "openid email profile"}
)
